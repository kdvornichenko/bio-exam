		...
		>
			...
			>
				<div
					...
					className="group-data-[variant=floating]:border-sidebar-border bg-sidebar flex h-full w-full flex-col backdrop-blur-md group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
				>
					{children}
				</div>
			</div>
