...
const SIDEBAR_WIDTH = "calc(var(--spacing)*24)";
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Устанавливаем cookie для сохранения состояния сайдбара.
  ...
  // Добавляет сочетание клавиш для переключения сайдбара.
  React.useEffect(() => {
  ...
  // Добавляем состояние, чтобы можно было использовать data-state="expanded" или "collapsed".
...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Обрабатывает отступ сайдбара на десктопе */}
      <div
      ...
      <div
        ...
        className={cn(
          ...
          // Корректируем отступы для floating и inset вариантов.
          variant === "floating" || variant === "inset"
      ...
      >
        <div
          ...
          className="flex h-full w-full flex-col bg-sidebar backdrop-blur-md group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
