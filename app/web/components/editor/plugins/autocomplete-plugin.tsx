...
// TODO поиск должен быть кастомным
...
// TODO запрос должен быть кастомным
  ...
  useEffect(() => {
    ...
    function $handleAutocompleteNodeTransform(node: AutocompleteNode) {
      ...
      if (node.__uuid === uuid && key !== autocompleteNodeKey) {
        // Максимум один узел автозаполнения за сессию
        $clearSuggestion();
      }
    }
...
/*
 * Симуляция асинхронного сервера автозаполнения (типично для более распространенных случаев использования, таких как GMail, где
