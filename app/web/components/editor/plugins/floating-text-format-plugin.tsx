...
function FloatingTextFormat({
	...
	return (
		<div
			...
			className="bg-background absolute left-0 top-0 flex gap-1 rounded-md border p-1 opacity-0 shadow-md transition-opacity duration-300 will-change-transform"
		>
			{editor.isEditable() && (
				<>
					<ToggleGroup
