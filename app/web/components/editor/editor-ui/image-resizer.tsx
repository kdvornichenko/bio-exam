...
export function ImageResizer({
	...
	return (
		<div ref={controlWrapperRef}>
			...
			/>
			<div
				className="image-resizer image-resizer-ne bg-primary absolute -right-2.5 -top-2.5 h-2 w-2 cursor-nesw-resize"
				onPointerDown={(event) => {
					handlePointerDown(event, Direction.north | Direction.east)
				}}
			/>
			<div
				className="image-resizer image-resizer-e bg-primary absolute -right-2.5 top-1/2 h-2 w-2 -translate-y-1/2 cursor-ew-resize"
				onPointerDown={(event) => {
					handlePointerDown(event, Direction.east)
				}}
			/>
			<div
				className="image-resizer image-resizer-se bg-primary absolute -bottom-2.5 -right-2.5 h-2 w-2 cursor-nwse-resize"
				onPointerDown={(event) => {
			...
			/>
			<div
				className="image-resizer image-resizer-w bg-primary absolute -left-2.5 top-1/2 h-2 w-2 -translate-y-1/2 cursor-ew-resize"
				onPointerDown={(event) => {
					handlePointerDown(event, Direction.west)
				}}
			/>
			<div
				className="image-resizer image-resizer-nw bg-primary absolute -left-2.5 -top-2.5 h-2 w-2 cursor-nwse-resize"
				onPointerDown={(event) => {
